        ...
        <div className="w-full max-w-[920px] px-4 sm:px-6 md:px-8">
          ...
          <div className="bg-white shadow-[0_0_25px_rgba(0,0,0,0.12)] rounded-2xl p-6 sm:p-8 md:p-10 md:px-[70px] lg:px-[100px]">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 text-sm mt-3">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        navigate(`/newaddress-errands?addressId=${item.id}`);
                      }}
            ...
            <p className="text-center mt-5 sm:mt-6">
              <button onClick={() => navigate('/newaddress-errands')} className="text-[#FF8C01] font-medium underline text-[16px] sm:text-[18px] cursor-pointer">
                Add New Address
              </button>
            </p>
